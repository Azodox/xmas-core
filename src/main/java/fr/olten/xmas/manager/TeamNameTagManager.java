...
public class TeamNameTagManager {
    ...
    public static void init(RankUnit rank){
        ...
        team.prefix(MiniMessage.miniMessage().deserialize(rank.getPrefix()));
        team.suffix(MiniMessage.miniMessage().deserialize(rank.getSuffix()));
        team.color(NamedTextColor.NAMES.value(rank.getColor()));
    ...
    public static void update(Player player){
        ...
        var accountManager = provider.getProvider().getAccountManager(player);
